...
const CategoryBadge = ({ category }: CategoryBadgeProps) => {
    const { borderColor, chipBackgroundColor, backgroundColor, textColor } = transactionCategoryStyles[category as keyof typeof transactionCategoryStyles] || transactionCategoryStyles.default;
    return (
